...
import fileService
import assetManager
from raceTracker import trackList
...
def new_recog(img):
    ...
    for s in subdivisions:
        try: pyautogui.locate(s, img, grayscale=True, confidence=0.95)
    ...
    for row in range(0, 12):
        for col in range(0, 8):
            ...
            try:
                if pyautogui.locate(current_track, track_img, grayscale=False, confidence=0.87):
